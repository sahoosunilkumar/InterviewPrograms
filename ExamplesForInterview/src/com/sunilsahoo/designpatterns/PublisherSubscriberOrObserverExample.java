...
/**
 * This is the class responsible for adding, remove,
 * disable analytics engine and send track.
 */
class AnalyticsManager {
    /**
     * Map to store all registered analytics engines.
     */
    private static HashMap<IAnalyticsInterface, Boolean> interfaces = new
            HashMap<IAnalyticsInterface, Boolean>();
     ...
     */
    public static void addAnalyticsEngine( IAnalyticsInterface
                                                  iAnalyticsInterface) {
     ...
     * @param iAnalyticsInterface
     */
    public static void removeAnalyticsEngine(IAnalyticsInterface
                                                     iAnalyticsInterface) {
     ...
     * @param iAnalyticsInterface
     */
    public static void disableAnalyticsEngine(IAnalyticsInterface
                                                      iAnalyticsInterface) {
