 ...
 * Elements can be added to the set, but not removed (though this can be addressed with 
 * a “counting” filter). The more elements that are added to the set, 
 * the larger the probability of false positives.
 * Here is the source code of the Java program to implement Bloom Filter. 
		...
		do {
			...
			case 2:
				...
				System.out.println("Search result : "
						+ bf.contains(new Integer(scan.nextInt())));
				break;
			case 3:
