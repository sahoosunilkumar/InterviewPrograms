...
//Here is the source code of the Java program to perform the dfs traversal. The Java program is successfully compiled and run on a Linux system. The program output is also shown below.
