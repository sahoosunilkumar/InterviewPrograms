 ...
 * on node objects in a heterogeneous aggregate structure. You want to avoid
 * "polluting" the node classes with these operations. And, you don't want to
 * have to query the type of each node and cast the pointer to the correct type
