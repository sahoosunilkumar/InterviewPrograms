 ...
 * These two parts of the principle appear to be contradictory. However, if you
 * correctly structure your classes and their dependencies, you can add
 * functionality without editing existing source code. Generally you achieve
 * this by referring to abstractions for dependencies, such as interfaces or
 * abstract classes, rather than using concrete classes. Functionality can be
 * added by creating new classes that implement the interfaces. Applying OCP to
 * your projects limits the need to change source code once it has been written,
 * tested and debugged. This reduces the risk of introducing new bugs to
 * existing code, leading to more robust software. Another side effect of the
 * use of interfaces for dependencies is reduced coupling and increased
 * flexibility.
 * 
