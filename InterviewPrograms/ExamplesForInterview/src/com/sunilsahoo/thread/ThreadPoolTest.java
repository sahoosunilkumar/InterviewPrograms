...
class ThreadPool10 {
    ...
    /* Constructor of ThreadPool10
     * nThreads= is a number of threads that exist in ThreadPool10.
    ...
    public ThreadPool10(int nThreads){
        ...
        for(int i=1; i<=nThreads; i++){
           ThreadPool10sThread threadPoolsThread=new ThreadPool10sThread(taskQueue,this);
    ...
    public synchronized void  execute(Runnable task) throws Exception{
        if(this.poolShutDownInitiated)
           throw new Exception("ThreadPool10 has been shutDown, no further tasks can be added");
    ...
    /**
     * Initiates shutdown of ThreadPool10, previously submitted tasks
...
class ThreadPool10sThread extends Thread {
    ...
    public void run() {
           try {
                  /*
                   * ThreadPool10's threads will keep on running
                   * until ThreadPool10 is not shutDown (shutDown will interrupt thread) and
                   * taskQueue contains some unExecuted tasks.
                   */
                  while (true) {    
                        System.out.println(Thread.currentThread().getName()
                                      +" is READY to execute task.");
                        /*ThreadPool10's thread will take() task from sharedQueue
...
public class ThreadPoolTest{
    public static void main(String[] args) throws Exception {
           ThreadPool10 threadPool=new ThreadPool10(2); //create 2 threads in ThreadPool10 
